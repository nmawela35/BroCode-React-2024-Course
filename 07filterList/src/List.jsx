export default function List() {
  ...
  fruits.sort((a, b) => a.calories - b.calories); //sort by calories ascending order

  const filterList = fruits.filter((fruit) => fruit.calories >= 46);
  const listItems = filterList.map((fruit) => (
    <li key={fruit.id}>
